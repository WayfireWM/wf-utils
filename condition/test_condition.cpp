...
test_condition_t::test_condition_t(const std::string &identifier, const symbol_t::value_t &value) : _identifier(identifier), _value(value)
{
}
...
equals_condition_t::equals_condition_t(const std::string &identifier, const symbol_t::value_t &value) : test_condition_t(identifier, value)
{
}
...
std::string equals_condition_t::to_string() const
{
    ...
    {
        out.append(std::to_string(std::get<int>(_value)));
    }
    else if (std::holds_alternative<std::string>(_value))
    {
        out.append(std::get<std::string>(_value));
    }
    else
    {
        out.append("*VALUE*");
